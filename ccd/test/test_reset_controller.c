 ...
 * $Header: /home/cjm/cvs/frodospec/ccd/test/test_reset_controller.c,v 1.1 2002-11-07 19:18:22 cjm Exp $
 */
#include <stdio.h>
#include <time.h>
#include "ccd_dsp.h"
...
/**
 * This program resets the DSP controller (nominally, the timimg board). This is usually done
 * as part of the initial startup sequence.
 * <pre>
 ...
 */
static char rcsid[] = "$Id: test_reset_controller.c,v 1.1 2002-11-07 19:18:22 cjm Exp $";
/**
...
static void Help(void)
{
	fprintf(stdout,"Test Reset Controller:Help.\n");
	fprintf(stdout,"This program resets the SDSU controller board (the timing board).\n");
	fprintf(stdout,"test_reset_controller [-i[nterface_device] <pci|text>]\n");
