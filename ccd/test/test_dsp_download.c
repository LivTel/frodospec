/* test_dsp_download.c
 * $Header: /home/cjm/cvs/frodospec/ccd/test/test_dsp_download.c,v 1.1 2002-11-07 19:18:22 cjm Exp $
 */
#include <stdio.h>
#include <time.h>
#include "ccd_dsp.h"
 ...
 */
static char rcsid[] = "$Id: test_dsp_download.c,v 1.1 2002-11-07 19:18:22 cjm Exp $";
/**
...
/* download filename to controller board */
	...
	fflush(stdout);
	retval = CCD_DSP_Download(Board,Filename);
	if(retval == FALSE)
	{
		CCD_Global_Error();
		return 4;
