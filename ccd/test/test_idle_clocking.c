...
*/
/* test_idle_clocking.c  -*- mode: Fundamental;-*-
 * $Header: /home/cjm/cvs/frodospec/ccd/test/test_idle_clocking.c,v 1.2 2006-05-16 18:18:27 cjm Exp $
 */
#include <stdio.h>
#include <time.h>
#include "ccd_dsp.h"
 ...
 */
static char rcsid[] = "$Id: test_idle_clocking.c,v 1.2 2006-05-16 18:18:27 cjm Exp $";
/**
...
int main(int argc, char *argv[])
{
	...
	switch(Command)
	{
		case COMMAND_ID_IDLE:
			...
			retval = CCD_DSP_Command_IDL();
			break;
		case COMMAND_ID_STOP:
			fprintf(stdout,"Calling CCD_DSP_Command_STP.\n");
			retval = CCD_DSP_Command_STP();
			break;
