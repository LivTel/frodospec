...
// $Header: /home/cjm/cvs/frodospec/java/ngat/frodospec/SETUPImplementation.java,v 1.1 2008-11-20 11:33:35 cjm Exp $
...
public class SETUPImplementation extends FITSImplementation implements JMSCommandImplementation
{
	 ...
	 */
	public final static String RCSID = new String("$Id: SETUPImplementation.java,v 1.1 2008-11-20 11:33:35 cjm Exp $");
	...
	public COMMAND_DONE processCommand(COMMAND command)
	{
		...
		setupDone.setErrorNum(FrodoSpecConstants.FRODOSPEC_ERROR_CODE_NO_ERROR);
