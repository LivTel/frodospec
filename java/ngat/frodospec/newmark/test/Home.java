...
public class Home
{
	 ...
	 * <li>Calls home to home the Newmark device..
	 ...
	 * @exception NewmarkNativeException Thrown if the home fails.
	 * @see #deviceName
	 * @see #deviceId
	 * @see #portNumber
	 * @see #logLevel
	 ...
	 * Example run: 
	 * <pre>java ngat.frodospec.newmark.test.Home -socket frodospec1serialports 3040</pre>
	 * <ul>
	 * <li>Calls parseArgs to parse the command line arguments.
	 * <li>Calls run method to home the Newmark slide.
	 * </ul>
	...
	public static void main(String[] args)
	{
		...
		{
			System.err.println("Home run failed:"+e);
			e.printStackTrace();
			System.exit(1);
		}
	}
