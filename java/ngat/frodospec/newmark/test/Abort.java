// Abort.java
// $Header: /home/cjm/cvs/frodospec/java/ngat/frodospec/newmark/test/Abort.java,v 1.2 2009-02-05 11:40:12 cjm Exp $
...
/**
 * This class tests the Frodospec Newmark library, by aborting filter slide movement using a Newmark controller
...
public class Abort
{
	 ...
	 */
	public final static String RCSID = new String("$Id: Abort.java,v 1.2 2009-02-05 11:40:12 cjm Exp $");
	/**
	 ...
	 * <li>Calls abort to abort the Newmark device.
	 ...
	 * @exception NewmarkNativeException Thrown if the abort fails.
	 * @see #deviceName
	 * @see #deviceId
	 * @see #portNumber
	 * @see #logLevel
	 ...
	 * @see ngat.frodospec.newmark.Newmark#abort
	 */
	 ...
	 * Example run: 
	 * <pre>java ngat.frodospec.newmark.test.Abort -socket frodospec1serialports 3040</pre>
	 * <ul>
	 * <li>Calls parseArgs to parse the command line arguments.
	 * <li>Calls run method to abort the Newmark slide.
	 * </ul>
	...
	public static void main(String[] args)
	{
		...
		{
			System.err.println("Abort run failed:"+e);
			e.printStackTrace();
			System.exit(1);
		}
	}
