/* df1_test_read_integer.c
** $Header: /home/cjm/cvs/frodospec/df1/test/df1_test_read_integer.c,v 1.1 2023-03-21 14:36:52 cjm Exp $
 */
 ...
 */
static char rcsid[] = "$Id: df1_test_read_integer.c,v 1.1 2023-03-21 14:36:52 cjm Exp $";
/**
...
int main(int argc, char *argv[])
{
	...
	/* read integer value */
	if(!Df1_Read_Integer(handle,SLC,PLC_Address,&value))
	{
		Df1_Error();
		return 4;
	}
	ivalue = (int)value;
	fprintf(stdout,"Test Read Integer:PLC Address '%s' has integer value %hu (%d)\n",PLC_Address,value,ivalue);
	/* close interface */
	...
	fprintf(stdout,"Test Read Integer:Finished Test ...\n");
	return 0;
}
...
static void Help(void)
{
	...
	fprintf(stdout,"df1_test_read_integer [-serial_device <filename>][-socket_device <address> <port>]\n");
