/* newmark_test_home.c
** $Header: /home/cjm/cvs/frodospec/newmark_motion_controller/test/newmark_test_home.c,v 1.2 2009-02-05 11:42:14 cjm Exp $
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
 ...
 */
static char rcsid[] = "$Id: newmark_test_home.c,v 1.2 2009-02-05 11:42:14 cjm Exp $";
/**
...
int main(int argc, char *argv[])
{
	...
	if(!Newmark_Command_Home(handle))
	{
		Newmark_Error();
		Arcom_ESS_Error();
		return 5;
