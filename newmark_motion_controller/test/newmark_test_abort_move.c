...
** $Header: /home/cjm/cvs/frodospec/newmark_motion_controller/test/newmark_test_abort_move.c,v 1.1 2008-11-20 11:35:54 cjm Exp $
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
 ...
 */
static char rcsid[] = "$Id: newmark_test_abort_move.c,v 1.1 2008-11-20 11:35:54 cjm Exp $";
/**
...
int main(int argc, char *argv[])
{
	...
	if(!Newmark_Command_Abort_Move(handle))
	{
		Newmark_Error();
		Arcom_ESS_Error();
		return 5;
